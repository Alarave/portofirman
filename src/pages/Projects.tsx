...
cosine_sim = cosine_similarity(tfidf_matrix, tfidf_matrix)`,
  },
  {
    ...
    metrics: [
      { label: "MAE", value: "214.05", color: "text-orange-500" },
      { label: "RMSE", value: "277.39", color: "text-blue-500" },
      { label: "MAPE", value: "2.53%", color: "text-primary" },
      { label: "R² Score", value: "0.6871", color: "text-cyan-600" },
      { label: "Direction Acc.", value: "47.11%", color: "text-emerald-600" },
    ],
    thumbnail: BBCA,
    image: BBCA,
    links: {
